...
export type ResolversInterfaceTypes<_RefType extends Record<string, unknown>> = ResolversObject<{
  ...
  ;
  Item:
    | ( Omit<AudioItem, 'creator' | 'file' | 'post'> & { creator: _RefType['User'], file: _RefType['AudioFile'], post: _RefType['Post'] } )
    | ( Omit<GifItem, 'creator' | 'file' | 'post'> & { creator: _RefType['User'], file: _RefType['GifFile'], post: _RefType['Post'] } )
    | ( Omit<ImageItem, 'creator' | 'file' | 'post'> & { creator: _RefType['User'], file: _RefType['PhotoFile'], post: _RefType['Post'] } )
    | ( Omit<ProcessingItem, 'creator' | 'post'> & { creator: _RefType['User'], post: _RefType['Post'] } )
    | ( Omit<VideoItem, 'creator' | 'file' | 'post'> & { creator: _RefType['User'], file: _RefType['VideoFile'], post: _RefType['Post'] } )
  ;
  Node:
    | ( Omit<AudioItem, 'creator' | 'file' | 'post'> & { creator: _RefType['User'], file: _RefType['AudioFile'], post: _RefType['Post'] } )
    | ( Omit<GifItem, 'creator' | 'file' | 'post'> & { creator: _RefType['User'], file: _RefType['GifFile'], post: _RefType['Post'] } )
...
export type ResolversTypes = ResolversObject<{
  ...
  AudioFile: ResolverTypeWrapper<Omit<AudioFile, 'creator'> & { creator: ResolversTypes['User'] }>;
  AudioItem: ResolverTypeWrapper<Omit<AudioItem, 'creator' | 'file' | 'post'> & { creator: ResolversTypes['User'], file: ResolversTypes['AudioFile'], post: ResolversTypes['Post'] }>;
  ...
  FileProcessingUpdate: ResolverTypeWrapper<Omit<FileProcessingUpdate, 'file'> & { file: ResolversTypes['File'] }>;
  FileType: FileType;
  Float: ResolverTypeWrapper<Scalars['Float']['output']>;
  Format: Format;
  GifFile: ResolverTypeWrapper<Omit<GifFile, 'creator'> & { creator: ResolversTypes['User'] }>;
  GifItem: ResolverTypeWrapper<Omit<GifItem, 'creator' | 'file' | 'post'> & { creator: ResolversTypes['User'], file: ResolversTypes['GifFile'], post: ResolversTypes['Post'] }>;
  ID: ResolverTypeWrapper<Scalars['ID']['output']>;
  ImageItem: ResolverTypeWrapper<Omit<ImageItem, 'creator' | 'file' | 'post'> & { creator: ResolversTypes['User'], file: ResolversTypes['PhotoFile'], post: ResolversTypes['Post'] }>;
  Int: ResolverTypeWrapper<Scalars['Int']['output']>;
  Item: ResolverTypeWrapper<ItemExternal>;
  ItemConnection: ResolverTypeWrapper<Omit<ItemConnection, 'nodes'> & { nodes: Array<ResolversTypes['Item']> }>;
  Keyword: ResolverTypeWrapper<KeywordExternal>;
  KeywordConnection: ResolverTypeWrapper<Omit<KeywordConnection, 'nodes'> & { nodes: Array<ResolversTypes['Keyword']> }>;
  Language: Language;
  ...
  PhotoFile: ResolverTypeWrapper<Omit<PhotoFile, 'creator'> & { creator: ResolversTypes['User'] }>;
  ...
  ProcessingItem: ResolverTypeWrapper<Omit<ProcessingItem, 'creator' | 'post'> & { creator: ResolversTypes['User'], post: ResolversTypes['Post'] }>;
  ProfilePictureFile: ResolverTypeWrapper<Omit<ProfilePictureFile, 'creator'> & { creator: ResolversTypes['User'] }>;
  ...
  VideoFile: ResolverTypeWrapper<Omit<VideoFile, 'creator'> & { creator: ResolversTypes['User'] }>;
  VideoItem: ResolverTypeWrapper<Omit<VideoItem, 'creator' | 'file' | 'post'> & { creator: ResolversTypes['User'], file: ResolversTypes['VideoFile'], post: ResolversTypes['Post'] }>;
}>;

/** Mapping between all available schema types and the resolvers parents */
export type ResolversParentTypes = ResolversObject<{
  AffectedItem: AffectedItem;
  AudioFile: Omit<AudioFile, 'creator'> & { creator: ResolversParentTypes['User'] };
  AudioItem: Omit<AudioItem, 'creator' | 'file' | 'post'> & { creator: ResolversParentTypes['User'], file: ResolversParentTypes['AudioFile'], post: ResolversParentTypes['Post'] };
  ...
  FileProcessingUpdate: Omit<FileProcessingUpdate, 'file'> & { file: ResolversParentTypes['File'] };
  Float: Scalars['Float']['output'];
  GifFile: Omit<GifFile, 'creator'> & { creator: ResolversParentTypes['User'] };
  GifItem: Omit<GifItem, 'creator' | 'file' | 'post'> & { creator: ResolversParentTypes['User'], file: ResolversParentTypes['GifFile'], post: ResolversParentTypes['Post'] };
  ID: Scalars['ID']['output'];
  ImageItem: Omit<ImageItem, 'creator' | 'file' | 'post'> & { creator: ResolversParentTypes['User'], file: ResolversParentTypes['PhotoFile'], post: ResolversParentTypes['Post'] };
  Int: Scalars['Int']['output'];
  Item: ItemExternal;
  ItemConnection: Omit<ItemConnection, 'nodes'> & { nodes: Array<ResolversParentTypes['Item']> };
  Keyword: KeywordExternal;
  KeywordConnection: Omit<KeywordConnection, 'nodes'> & { nodes: Array<ResolversParentTypes['Keyword']> };
  ...
  Passkey: Passkey;
  PhotoFile: Omit<PhotoFile, 'creator'> & { creator: ResolversParentTypes['User'] };
  Post: PostExternal;
  PostConnection: Omit<PostConnection, 'nodes'> & { nodes: Array<ResolversParentTypes['Post']> };
  ProcessingItem: Omit<ProcessingItem, 'creator' | 'post'> & { creator: ResolversParentTypes['User'], post: ResolversParentTypes['Post'] };
  ProfilePictureFile: Omit<ProfilePictureFile, 'creator'> & { creator: ResolversParentTypes['User'] };
  ...
  VideoFile: Omit<VideoFile, 'creator'> & { creator: ResolversParentTypes['User'] };
  VideoItem: Omit<VideoItem, 'creator' | 'file' | 'post'> & { creator: ResolversParentTypes['User'], file: ResolversParentTypes['VideoFile'], post: ResolversParentTypes['Post'] };
}>;

export type AffectedItemResolvers<ContextType = Context, ParentType extends ResolversParentTypes['AffectedItem'] = ResolversParentTypes['AffectedItem']> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  position?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>;
  typename?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
}>;

export type AudioFileResolvers<ContextType = Context, ParentType extends ResolversParentTypes['AudioFile'] = ResolversParentTypes['AudioFile']> = ResolversObject<{
  ...
  unmodifiedCompressedPath?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  waveform?: Resolver<Array<ResolversTypes['Float']>, ParentType, ContextType>;
  waveformThumbnail?: Resolver<Array<ResolversTypes['Float']>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type AudioItemResolvers<ContextType = Context, ParentType extends ResolversParentTypes['AudioItem'] = ResolversParentTypes['AudioItem']> = ResolversObject<{
...
export type CropMetadataResolvers<ContextType = Context, ParentType extends ResolversParentTypes['CropMetadata'] = ResolversParentTypes['CropMetadata']> = ResolversObject<{
...
export type FileResolvers<ContextType = Context, ParentType extends ResolversParentTypes['File'] = ResolversParentTypes['File']> = ResolversObject<{
  __resolveType: TypeResolveFn<'AudioFile' | 'GifFile' | 'PhotoFile' | 'ProfilePictureFile' | 'VideoFile', ParentType, ContextType>;
}>;

export type FileModificationsResolvers<ContextType = Context, ParentType extends ResolversParentTypes['FileModifications'] = ResolversParentTypes['FileModifications']> = ResolversObject<{
  crop?: Resolver<Maybe<ResolversTypes['CropMetadata']>, ParentType, ContextType>;
  fileType?: Resolver<Maybe<ResolversTypes['FileType']>, ParentType, ContextType>;
  normalize?: Resolver<Maybe<ResolversTypes['NormalizeMetadata']>, ParentType, ContextType>;
  template?: Resolver<Maybe<ResolversTypes['TemplateConfig']>, ParentType, ContextType>;
  trim?: Resolver<Maybe<ResolversTypes['TrimMetadata']>, ParentType, ContextType>;
}>;

export type FileProcessingUpdateResolvers<ContextType = Context, ParentType extends ResolversParentTypes['FileProcessingUpdate'] = ResolversParentTypes['FileProcessingUpdate']> = ResolversObject<{
  affectedItems?: Resolver<Maybe<Array<ResolversTypes['AffectedItem']>>, ParentType, ContextType>;
  file?: Resolver<ResolversTypes['File'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  kind?: Resolver<ResolversTypes['UpdateKind'], ParentType, ContextType>;
}>;

export type GifFileResolvers<ContextType = Context, ParentType extends ResolversParentTypes['GifFile'] = ResolversParentTypes['GifFile']> = ResolversObject<{
  compressedGifPath?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  compressedPath?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  creator?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type GifItemResolvers<ContextType = Context, ParentType extends ResolversParentTypes['GifItem'] = ResolversParentTypes['GifItem']> = ResolversObject<{
  caption?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  creator?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type ImageItemResolvers<ContextType = Context, ParentType extends ResolversParentTypes['ImageItem'] = ResolversParentTypes['ImageItem']> = ResolversObject<{
  caption?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  creator?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type ItemResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Item'] = ResolversParentTypes['Item']> = ResolversObject<{
  __resolveType: TypeResolveFn<'AudioItem' | 'GifItem' | 'ImageItem' | 'ProcessingItem' | 'VideoItem', ParentType, ContextType>;
}>;

export type ItemConnectionResolvers<ContextType = Context, ParentType extends ResolversParentTypes['ItemConnection'] = ResolversParentTypes['ItemConnection']> = ResolversObject<{
...
export type KeywordResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Keyword'] = ResolversParentTypes['Keyword']> = ResolversObject<{
  ...
  posts?: Resolver<Maybe<ResolversTypes['PostConnection']>, ParentType, ContextType, Partial<KeywordPostsArgs>>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type KeywordConnectionResolvers<ContextType = Context, ParentType extends ResolversParentTypes['KeywordConnection'] = ResolversParentTypes['KeywordConnection']> = ResolversObject<{
  endCursor?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  hasNextPage?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  hasPreviousPage?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
...
export type LoginResultResolvers<ContextType = Context, ParentType extends ResolversParentTypes['LoginResult'] = ResolversParentTypes['LoginResult']> = ResolversObject<{
  pendingToken?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type MutationResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  ...
  changeName?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationChangeNameArgs, 'newName'>>;
  ...
  clearProfilePicture?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  confirmTotp?: Resolver<ResolversTypes['TotpConfirmResult'], ParentType, ContextType, RequireFields<MutationConfirmTotpArgs, 'code'>>;
  convertItem?: Resolver<ResolversTypes['String'], ParentType, ContextType, RequireFields<MutationConvertItemArgs, 'itemId' | 'targetType'>>;
  createKeyword?: Resolver<ResolversTypes['Keyword'], ParentType, ContextType, RequireFields<MutationCreateKeywordArgs, 'name'>>;
  createPost?: Resolver<ResolversTypes['Post'], ParentType, ContextType, RequireFields<MutationCreatePostArgs, 'language' | 'title'>>;
  cropItem?: Resolver<ResolversTypes['String'], ParentType, ContextType, RequireFields<MutationCropItemArgs, 'crop' | 'itemId'>>;
  deleteItem?: Resolver<ResolversTypes['ID'], ParentType, ContextType, RequireFields<MutationDeleteItemArgs, 'itemId'>>;
  deleteKeyword?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeleteKeywordArgs, 'keywordId'>>;
  deletePasskey?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDeletePasskeyArgs, 'passkeyId'>>;
  ...
  disableTotp?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationDisableTotpArgs, 'code' | 'password'>>;
  ...
  generatePasskeyAuthenticationOptions?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  generatePasskeyRegistrationOptions?: Resolver<ResolversTypes['String'], ParentType, ContextType, Partial<MutationGeneratePasskeyRegistrationOptionsArgs>>;
  initTotp?: Resolver<ResolversTypes['TotpSetupResult'], ParentType, ContextType>;
  ...
  mergePost?: Resolver<ResolversTypes['Int'], ParentType, ContextType, RequireFields<MutationMergePostArgs, 'mergeKeywords' | 'sourcePostId' | 'targetPostId'>>;
  modifyItem?: Resolver<ResolversTypes['String'], ParentType, ContextType, RequireFields<MutationModifyItemArgs, 'itemId'>>;
  moveItem?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationMoveItemArgs, 'itemId' | 'keepEmptyPost' | 'targetPostId'>>;
  normalizeItem?: Resolver<ResolversTypes['String'], ParentType, ContextType, RequireFields<MutationNormalizeItemArgs, 'itemId' | 'normalize'>>;
  regenerateRecoveryCodes?: Resolver<ResolversTypes['TotpConfirmResult'], ParentType, ContextType, RequireFields<MutationRegenerateRecoveryCodesArgs, 'code' | 'password'>>;
  ...
  renamePasskey?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationRenamePasskeyArgs, 'name' | 'passkeyId'>>;
  ...
  setItemTemplate?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationSetItemTemplateArgs, 'itemId'>>;
  ...
  uploadItemFile?: Resolver<ResolversTypes['ID'], ParentType, ContextType, RequireFields<MutationUploadItemFileArgs, 'file'>>;
  ...
  verifyLoginTotp?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationVerifyLoginTotpArgs, 'code' | 'pendingToken'>>;
  verifyPasskeyAuthentication?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationVerifyPasskeyAuthenticationArgs, 'response'>>;
  verifyPasskeyRegistration?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType, RequireFields<MutationVerifyPasskeyRegistrationArgs, 'response'>>;
}>;

export type NodeResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Node'] = ResolversParentTypes['Node']> = ResolversObject<{
  __resolveType: TypeResolveFn<'AudioItem' | 'GifItem' | 'ImageItem' | 'Keyword' | 'Post' | 'ProcessingItem' | 'Session' | 'User' | 'VideoItem', ParentType, ContextType>;
}>;

export type NormalizeMetadataResolvers<ContextType = Context, ParentType extends ResolversParentTypes['NormalizeMetadata'] = ResolversParentTypes['NormalizeMetadata']> = ResolversObject<{
  enabled?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
}>;

export type PasskeyResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Passkey'] = ResolversParentTypes['Passkey']> = ResolversObject<{
...
export type PhotoFileResolvers<ContextType = Context, ParentType extends ResolversParentTypes['PhotoFile'] = ResolversParentTypes['PhotoFile']> = ResolversObject<{
  compressedPath?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  creator?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type PostResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Post'] = ResolversParentTypes['Post']> = ResolversObject<{
  ...
  creator?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  items?: Resolver<ResolversTypes['ItemConnection'], ParentType, ContextType, Partial<PostItemsArgs>>;
...
export type ProcessingItemResolvers<ContextType = Context, ParentType extends ResolversParentTypes['ProcessingItem'] = ResolversParentTypes['ProcessingItem']> = ResolversObject<{
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  creator?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
...
export type ProfilePictureFileResolvers<ContextType = Context, ParentType extends ResolversParentTypes['ProfilePictureFile'] = ResolversParentTypes['ProfilePictureFile']> = ResolversObject<{
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  creator?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  modifications?: Resolver<Maybe<ResolversTypes['FileModifications']>, ParentType, ContextType>;
  ...
  profilePicture256?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  unmodifiedCompressedPath?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;
...
export type QueryResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  items?: Resolver<Maybe<ResolversTypes['ItemConnection']>, ParentType, ContextType, Partial<QueryItemsArgs>>;
  keywords?: Resolver<Maybe<ResolversTypes['KeywordConnection']>, ParentType, ContextType, Partial<QueryKeywordsArgs>>;
  me?: Resolver<Maybe<ResolversTypes['User']>, ParentType, ContextType>;
  node?: Resolver<ResolversTypes['Node'], ParentType, ContextType, RequireFields<QueryNodeArgs, 'id'>>;
  ...
  userSessions?: Resolver<Array<ResolversTypes['Session']>, ParentType, ContextType>;
...
export type SubscriptionResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Subscription'] = ResolversParentTypes['Subscription']> = ResolversObject<{
  fileProcessingUpdates?: SubscriptionResolver<ResolversTypes['FileProcessingUpdate'], "fileProcessingUpdates", ParentType, ContextType, RequireFields<SubscriptionFileProcessingUpdatesArgs, 'ids'>>;
}>;

export type TemplateAreaResolvers<ContextType = Context, ParentType extends ResolversParentTypes['TemplateArea'] = ResolversParentTypes['TemplateArea']> = ResolversObject<{
  ...
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  imageFit?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
...
export type TemplateConfigResolvers<ContextType = Context, ParentType extends ResolversParentTypes['TemplateConfig'] = ResolversParentTypes['TemplateConfig']> = ResolversObject<{
  areas?: Resolver<Array<ResolversTypes['TemplateArea']>, ParentType, ContextType>;
}>;

export type TotpConfirmResultResolvers<ContextType = Context, ParentType extends ResolversParentTypes['TotpConfirmResult'] = ResolversParentTypes['TotpConfirmResult']> = ResolversObject<{
  recoveryCodes?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType>;
}>;

export type TotpSetupResultResolvers<ContextType = Context, ParentType extends ResolversParentTypes['TotpSetupResult'] = ResolversParentTypes['TotpSetupResult']> = ResolversObject<{
...
export type TotpStatusResolvers<ContextType = Context, ParentType extends ResolversParentTypes['TotpStatus'] = ResolversParentTypes['TotpStatus']> = ResolversObject<{
  enabled?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  recoveryCodesRemaining?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
}>;

export type TrimMetadataResolvers<ContextType = Context, ParentType extends ResolversParentTypes['TrimMetadata'] = ResolversParentTypes['TrimMetadata']> = ResolversObject<{
...
export type UserResolvers<ContextType = Context, ParentType extends ResolversParentTypes['User'] = ResolversParentTypes['User']> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  linkedTelegram?: Resolver<Maybe<ResolversTypes['Boolean']>, ParentType, ContextType>;
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  passkeys?: Resolver<Maybe<Array<ResolversTypes['Passkey']>>, ParentType, ContextType>;
  postCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  posts?: Resolver<Maybe<ResolversTypes['PostConnection']>, ParentType, ContextType, Partial<UserPostsArgs>>;
  profilePicture?: Resolver<Maybe<ResolversTypes['ProfilePictureFile']>, ParentType, ContextType>;
  totpStatus?: Resolver<Maybe<ResolversTypes['TotpStatus']>, ParentType, ContextType>;
...
export type VideoFileResolvers<ContextType = Context, ParentType extends ResolversParentTypes['VideoFile'] = ResolversParentTypes['VideoFile']> = ResolversObject<{
  compressedPath?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  creator?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  id?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  ...
  thumbnailPath?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  unmodifiedCompressedPath?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  unmodifiedThumbnailPosterPath?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  updatedAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
}>;

export type VideoItemResolvers<ContextType = Context, ParentType extends ResolversParentTypes['VideoItem'] = ResolversParentTypes['VideoItem']> = ResolversObject<{
  caption?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes['DateTime'], ParentType, ContextType>;
  creator?: Resolver<ResolversTypes['User'], ParentType, ContextType>;
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
